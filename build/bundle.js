...
var _foot = __webpack_require__(81);

var _foot2 = _interopRequireDefault(_foot);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var reducers = (0, _redux.combineReducers)({ list: _list2.default, footer: _foot2.default });
...
var _foot = __webpack_require__(74);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { onClick: function onClick() {
                        _this2.props.dispatch((0, _list.add)({
                            id: Date.now() + '',
                            text: _this2.refs.input.value,
                            complete: false
                        }));
                    ...
                    this.props.list.map(function (v) {
                        if (v.complete) {
                            return _react2.default.createElement(
                                'li',
                                { key: v.id.toString() },
                                _react2.default.createElement('input', { checked: v.complete, type: 'checkbox', onChange: function onChange() {
                                        dispatch((0, _list.edit)({ id: v.id, complete: !v.complete }));
                                    } }),
                                _react2.default.createElement(
                                    's',
                                    null,
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    switch (state.footer) {
        case "all":
            ...
            break;
        case "complete":
            list = state.list.filter(function (v) {
                return v.complete;
            });
            break;
        case "uncomplete":
...
var _foot = __webpack_require__(30);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { onClick: function onClick() {
                            _this2.props.dispatch((0, _foot.change)("all"));
                        }, href: 'javascript:;' },
                    '\u5168\u90E8'
                ),
                _react2.default.createElement(
                    'a',
                    { onClick: function onClick() {
                            _this2.props.dispatch((0, _foot.change)("complete"));
                        }, href: 'javascript:;' },
                    '\u5DF2\u5B8C\u6210'
                ),
                _react2.default.createElement(
                    'a',
                    { onClick: function onClick() {
                            _this2.props.dispatch((0, _foot.change)("uncomplete"));
                        }, href: 'javascript:;' },
                    '\u672A\u5B8C\u6210'
                )
            );
